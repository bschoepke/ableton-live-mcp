...
def make_host_patch(role: str, instance_id: str, title: str | None = None, device_width: int | None = None) -> dict[str, Any]:
    ...
    boxes = [
        ...
        _box("self-path", "newobj", "live.path", 520.0, 96.0),
        ...
        _box("trigger-path", "newobj", "live.path", 680.0, 96.0),
        ...
        _box("command-filewatch-start", "message", "1", 860.0, 96.0),
        _box(
            "command-trigger",
            "live.numbox",
            None,
    ...
    lines = [
        ...
        _line("poll-loadbang", 0, "command-filewatch-start", 0),
        _line("poll-live-device", 0, "command-filewatch-start", 0),
        _line("command-filewatch-start", 0, "command-filewatch", 0),
        _line("command-filewatch", 0, "js", 0),
