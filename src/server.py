...
ABLETON_MCP_INSTRUCTIONS = (
    ...
    "Compact exec/batch; cap props/children/strings. "
    "find_similar_sounds requires Live 12+. "
    "AgentAudioTap: master tap+solo target; start with path. "
    "Validate runtime_current. Idle sockets auto-retry; sent-call timeouts fail closed; client/RS cooldown+serialize; live_bridge_status timeout=wedged. Save/recover modals: inspect UI, no retry mutations. "
