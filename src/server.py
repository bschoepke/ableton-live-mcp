...
ABLETON_MCP_INSTRUCTIONS = (
    ...
    "Validate runtime_current; no-arg known-tool schema=stale MCP, reload. Idle sockets auto-retry; sent-call timeouts fail closed; client/RS cooldown+serialize; live_bridge_status timeout=wedged. Save/recover modals: inspect UI, no retry mutations. "
